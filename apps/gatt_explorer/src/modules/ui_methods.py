...
def set_theme_button_icon(main_window):
    icon = QIcon()
    icon.addPixmap(
        QPixmap("../../common/assets/images/icons/theme_mode.png"),
        QIcon.Normal,
        QIcon.On,
    )
...
def set_menu_button_icon(main_window):
    icon = QIcon()
    icon.addPixmap(
        QPixmap("../../common/assets/images/icons/icon_settings.png"),
        QIcon.Normal,
        QIcon.On,
    )
    # set button width and height
...
def start_box_animation(main_window, left_box_width, right_box_width, direction):
    ...
    # # ANIMATION LEFT BOX
    main_window.left_box = QPropertyAnimation(
        main_window.ui.frame_main_left, b"minimumWidth"
    )
    ...
    # ANIMATION RIGHT BOX
    main_window.right_box = QPropertyAnimation(
        main_window.ui.frame_main_right, b"minimumWidth"
    )
