...
class Ui_areYouSure_popup(object):
    def setupUi(self, areYouSure_popupV3):
        if not areYouSure_popupV3.objectName():
            areYouSure_popupV3.setObjectName(u"areYouSure_popupV3")
        areYouSure_popupV3.setWindowModality(Qt.ApplicationModal)
        areYouSure_popupV3.resize(485, 120)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(areYouSure_popupV3.sizePolicy().hasHeightForWidth())
        ...
        self.popupView.setObjectName(u"popupView")
        self.saveNeededPage = QWidget()
        self.saveNeededPage.setObjectName(u"saveNeededPage")
        ...
        self.saveNeeded_noSave.setObjectName(u"saveNeeded_noSave")

        self.gridLayout_3.addWidget(self.saveNeeded_noSave, 2, 1, 1, 1)

        self.saveNeeded_cancel = QPushButton(self.frame1)
        self.saveNeeded_cancel.setObjectName(u"saveNeeded_cancel")

        self.gridLayout_3.addWidget(self.saveNeeded_cancel, 2, 2, 1, 1)

        self.saveNeeded_warningIcon = QLabel(self.frame1)
        self.saveNeeded_warningIcon.setObjectName(u"saveNeeded_warningIcon")
        sizePolicy.setHeightForWidth(self.saveNeeded_warningIcon.sizePolicy().hasHeightForWidth())
        ...
        self.confirmMovePage.setObjectName(u"confirmMovePage")
        ...
        self.confirmMove_cancel.setObjectName(u"confirmMove_cancel")

        self.gridLayout_4.addWidget(self.confirmMove_cancel, 1, 2, 1, 1)

        self.horizontalSpacer = QSpacerItem(117, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_4.addItem(self.horizontalSpacer, 1, 1, 1, 1)

        self.confirmMove_move = QPushButton(self.frame2)
        self.confirmMove_move.setObjectName(u"confirmMove_move")

        self.gridLayout_4.addWidget(self.confirmMove_move, 1, 3, 1, 1)

        self.confirmMove_warningIcon = QLabel(self.frame2)
        self.confirmMove_warningIcon.setObjectName(u"confirmMove_warningIcon")
        sizePolicy.setHeightForWidth(self.confirmMove_warningIcon.sizePolicy().hasHeightForWidth())
        ...
        self.confirmMove_msg1.setObjectName(u"confirmMove_msg1")
        ...
        self.confirmDeletePage.setObjectName(u"confirmDeletePage")
        ...
        self.confirmDelete_cancel.setObjectName(u"confirmDelete_cancel")

        self.gridLayout_6.addWidget(self.confirmDelete_cancel, 2, 2, 1, 1)

        self.confirmDelete_warningIcon = QLabel(self.frame3)
        self.confirmDelete_warningIcon.setObjectName(u"confirmDelete_warningIcon")
        sizePolicy.setHeightForWidth(self.confirmDelete_warningIcon.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, areYouSure_popupV3):
        areYouSure_popupV3.setWindowTitle(QCoreApplication.translate("areYouSure_popupV3", u"Form", None))
        self.saveNeeded_noSave.setText(QCoreApplication.translate("areYouSure_popupV3", u"Don't Save", None))
        self.saveNeeded_cancel.setText(QCoreApplication.translate("areYouSure_popupV3", u"Cancel", None))
        self.saveNeeded_warningIcon.setText("")
        self.saveNeeded_save.setText(QCoreApplication.translate("areYouSure_popupV3", u"Save", None))
        self.saveNeeded_msg1.setText("")
        self.saveNeeded_msg2.setText(QCoreApplication.translate("areYouSure_popupV3", u"Changes that have not been saved will be lost.", None))
        self.confirmMove_cancel.setText(QCoreApplication.translate("areYouSure_popupV3", u"Cancel", None))
        self.confirmMove_move.setText(QCoreApplication.translate("areYouSure_popupV3", u"Move", None))
        self.confirmMove_warningIcon.setText("")
        self.confirmMove_msg1.setText("")
        self.confirmDelete_cancel.setText(QCoreApplication.translate("areYouSure_popupV3", u"Cancel", None))
        self.confirmDelete_warningIcon.setText("")
        self.confirmDelete_delete.setText(QCoreApplication.translate("areYouSure_popupV3", u"Delete", None))
        self.confirmDelete_msg1.setText("")
        self.confirmDelete_msg2.setText(QCoreApplication.translate("areYouSure_popupV3", u"This file can be restored from the system trash.", None))
    # retranslateUi
